...
$data = $bdd->query("SELECT * FROM logement");
$logement = $data->fetchAll(PDO::FETCH_ASSOC);
...
<html lang="en">
  ...
  <body>
    <h1 class="display-4 text-center">fiche Logement</h1>

    <table class="table col-md-8 mx-auto table-bordered text-center tab1">
    
     <!-- pour chaque entrée dans la bdd , j'affiche dans un tableau chaque indice et valeurs par tour de boucle -->
...
<button class="btn btn-success color-white col-md-4 offset-md-4"><a href="index.php" action="">Retour au formulaire d'insersion</button> </a>
