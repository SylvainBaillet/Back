...
<link rel="canonical" href="https://startbootstrap.com/templates/shop-homepage/">
...
<meta property="og:url" content="https://startbootstrap.com/templates/shop-homepage/">
<meta property="og:image:alt" content="Shop Homepage - Bootstrap Ecommerce Store Template">
...
<h1 class="mb-2">Shop Homepage</h1>
<h2 class="m-0">A simple, unstyled, shop home page template with star icons and a header carousel</h2>
</div>
<div class="col-lg-4">
<script async type="text/javascript" src="//cdn.carbonads.com/carbon.js?serve=CKYIP53E&placement=startbootstrapcom" id="_carbonads_js"></script>
</div>
</div>
</div>
...
<a class="img-preview d-block shadow-lg rounded mb-4" target="_blank" href="/previews/shop-homepage/">
<img class="img-fluid rounded" src="/assets/img/screenshots/templates/shop-homepage.png" alt="Free Bootstrap Ecommerce Template">
...
<div class="card-body">
<a target="_blank" href="https://github.com/BlackrockDigital/startbootstrap-shop-homepage/archive/gh-pages.zip" class="btn btn-block btn-primary mb-3 py-3" onclick="ga('send','event','Download','click','Shop Homepage')">
<i class="fal fa-download fa-fw"></i> <span>Free Download</span>
</a>
<hr>
<a target="_blank" href="/previews/shop-homepage/" class="btn btn-block btn-outline-primary mb-3"><i class="far fa-browser fa-fw"></i> Live Preview</a>
<a target="_blank" href="https://github.com/BlackrockDigital/startbootstrap-shop-homepage" class="btn btn-block btn-outline-github"><i class="fab fa-github fa-fw"></i> View on GitHub</a>
</div>
</div>
...
<div class="card-body">
<div class="small mb-2 font-weight-bold">Get updates when Shop Homepage is improved!</div>
...
<span><i class="fal fa-balance-scale"></i> <a class="font-weight-bold" href="https://github.com/BlackrockDigital/startbootstrap-shop-homepage/blob/master/LICENSE">MIT License</a></span>
</div>
<hr class="my-2">
<div class="d-flex justify-content-between small">
<span class="font-weight-bold">Released</span>
<span>Nov 23, 2013</span>
</div>
<hr class="my-2">
<div class="d-flex justify-content-between small">
...
<a class="item-preview-img box-shadow-lg d-block" href="https://www.creative-tim.com/product/material-kit-pro/?affiliate_id=101249" onclick="ga('send','event','Affiliate Link','click','Creative Tim - Material Kit Pro')" rel="nofollow">
...
<div class="col-6 mb-4">
<div class="item-preview">
<a class="item-preview-img box-shadow-lg d-block" href="https://www.creative-tim.com/product/material-kit-pro-react/?affiliate_id=101249" onclick="ga('send','event','Affiliate Link','click','Creative Tim - Material Kit Pro React')" rel="nofollow">
...
<div class="col-6 mb-4">
<div class="item-preview">
<a class="item-preview-img box-shadow-lg d-block" href="https://www.creative-tim.com/product/now-ui-kit-pro/?affiliate_id=101249" onclick="ga('send','event','Affiliate Link','click','Creative Tim - Now UI Kit Pro')" rel="nofollow">
<img class="img-fluid" src="/assets/img/screenshots/premium/creative-tim/nukp.jpg" alt="Now UI Kit - Premium Bootstrap 4 UI Kit">
 ...
 <div class="col-6 mb-4">
<div class="item-preview">
<a class="item-preview-img box-shadow-lg d-block" href="https://www.creative-tim.com/product/paper-kit-2-pro/?affiliate_id=101249" onclick="ga('send','event','Affiliate Link','click','Creative Tim - Paper Kit 2 Pro')" rel="nofollow">
