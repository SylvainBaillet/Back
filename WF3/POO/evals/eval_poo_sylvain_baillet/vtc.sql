...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 28 mai 2019 à 16:49
...
CREATE TABLE `association_vehicule_conducteur` (
  ...
  `id_vehicule` int(6) NOT NULL,
  `id_conducteur` int(6) NOT NULL
...
(504, 'wolkswagen', 'Tournan', 'noir', 'SO-322-NV'),
(505, 'Skoda', 'Octavia', 'gris', 'PB-631-TK'),
(506, 'wolkswagen', 'Passat', 'gris', 'XN-973-MM');
